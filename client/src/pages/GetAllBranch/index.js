...
const GetAllBranch = () => {
    ...
    React.useEffect(() => {
        fetch("/api/get-all-branch?projectid=4cd92f5c-4d71-418f-841b-de2516cc9005&repositoryid=97286a02-cd61-40a8-90e6-ab830cc2deba")
        .then((res) => res.json())
        .then((data) => setData(data));
    }, []);

    return <Section title="Get All Branch">
